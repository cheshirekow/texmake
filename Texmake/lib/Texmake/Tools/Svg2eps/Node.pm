...
package Texmake::Tools::Svg2eps::Node;
...
sub new
{
    ...
    {
        die "Svg2eps node created with wrong argument list";
    }
...
sub build
{
    ...
    print_n "In svg2eps node's build method";
    ...
    my $cmd = "svg2eps $srcfile $outfile";   
